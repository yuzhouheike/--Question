...
//        
//        view.backgroundColor = [UIColor colorWithWhite:(arc4random_uniform(1000)/1000.0) alpha:1];
//    }
    ...
    [_numberOfQuestionLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.equalTo(_questionSubButton.mas_right);
    ...
    [_questionSumButton mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.equalTo(_numberOfQuestionLabel.mas_right);
    }];
}
